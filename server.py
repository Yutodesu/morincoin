...
def init_db():
    ...
    # Distribuição de saldos para impressionar os usuários (maioria 150, surpresas de 500 e 1000)
    ...
    for email, senha, username in logins_adicionais:
        try:
            ...
            # Se o banco na Render já tiver o usuário criado, ele ignora e mantém o saldo antigo intacto
            pass
...
def register():
    if request.method == 'POST':
        ...
        # Validação real do código gerado pelo Admin
        ...
        try:
            # Cria a conta nova com saldo inicial bônus de 50 MRN
            cursor.execute("INSERT INTO usuarios (email, senha, username, saldo) VALUES (?, ?, ?, 50)", (email, senha, username))
            # Invalida o código no painel do Admin para que ninguém mais use
