...
def init_db():
    ...
    # === NOVOS LOGINS ADICIONADOS COM CUIDADO AQUI ===
    # Contas de teste adicionais (como Administradores para dar acesso ao Painel Mestre)
    logins_adicionais = [
    ...
    for email, senha, username in logins_adicionais:
        try:
            cursor.execute("INSERT INTO usuarios (email, senha, username, saldo, is_admin) VALUES (?, ?, ?, 10000, 1)", (email, senha, username))
        except sqlite3.IntegrityError:
            pass
    # ==========================================================
