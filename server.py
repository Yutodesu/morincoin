...
def init_db():
"""Cria as tabelas no PostgreSQL se elas não existirem e atualiza colunas se necessário"""
conn = get_db_connection()
cursor = conn.cursor()

# 1. Cria a tabela básica de usuários se não existir
cursor.execute('''
...
# 2. SE A COLUNA 'pin' NÃO EXISTIR NA TABELA ANTIGA, ADICIONA ELA AGORA!
try:
cursor.execute("ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS pin TEXT DEFAULT '000000'")
conn.commit()
except Exception:
conn.rollback()
...
<!-- 1. POP-UP INICIAL DE AVISO (Abre direto ao entrar no site) -->
<div id="welcomeModal" class="modal" style="display: flex;">
<div class="modal-content" style="text-align: center;">
<span class="close-btn" onclick="fecharModal('welcomeModal')">×</span>
...
<!-- 2. POP-UP DE FAQ (SAIBA MAIS) -->
<div id="faqModal" class="modal">
<div class="modal-content">
<span class="close-btn" onclick="fecharModal('faqModal')">×</span>
...
<div class="faq-item">
<div class="faq-question" onclick="toggleFaq(this)">- O MorinCoin é um investmento?</div>
...
<!-- 3. POP-UP DE SUPORTE (PROBLEMAS PARA LOGAR) -->
<div id="suporteModal" class="modal">
<div class="modal-content">
<span class="close-btn" onclick="fecharModal('suporteModal')">×</span>
...
<!-- Barra Superior do Email com o Switch -->
...
<!-- LÓGICA EM JAVASCRIPT DA INTERFACE -->
<script>
