...
## 📱 MorinCoin Offline (APK Android) — v2.0
...
- 💸 **Envio e importação de MRN funcionando**
- 🧪 **Várias funções novas em desenvolvimento** (algumas ainda em correção)
...
👉 [github.com/Yutodesu/MorinCoin-App/releases/tag/v2.0](https://github.com/Yutodesu/MorinCoin-App/releases/tag/v2.0)

> Repositório do app: [Yutodesu/MorinCoin-App](https://github.com/Yutodesu/MorinCoin-App)
